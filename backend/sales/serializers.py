...
class SaleCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        # Si un serveur est spécifié dans les données (cas du caissier qui sélectionne un serveur)
        if 'server' in validated_data and validated_data['server']:
            # Garder le serveur spécifié
            pass
